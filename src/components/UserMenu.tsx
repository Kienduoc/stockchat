...
export default function UserMenu() {
  ...
  if (loading) {
    return <div className="w-24 h-8 bg-white/20 rounded-lg animate-pulse" />;
  }
  ...
  if (!user) {
    return (
      <button
        ...
        className="flex items-center gap-2 bg-white text-gray-700 px-3 py-1.5 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-colors shadow"
      >
